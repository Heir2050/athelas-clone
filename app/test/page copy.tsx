...
export default function HomePage() {
    ...
    useEffect(() => {
        ...
        // Si la section est complètement sortie du viewport (vers le haut)
        if (sectionBottom <= 0) {
            console.log('Section complètement sortie - Header fixed top');
            setIsHeaderFixed(true);
            setHeaderPosition('top');
        }
        // Si la section est visible dans le viewport
        else {
            console.log('Section visible - Header suit la section');
    ...
    const getHeaderClasses = () => {
        const baseClasses = "w-full z-50 transition-all duration-300 ease-in-out bg-white shadow-lg";
