                ...
                <div className="home-featured-products_grid">
                    <div className="card one">
                        <div className="home-featured-products">
                            ...
                            <Image src="/products-1.png" alt="img" width={800} height={600} style={{ width: '100%', height: 'auto', marginBottom: '1rem'}} className="relative"/>
                    ...
                    <div className="card two">
                        <div className="home-featured-products">
                            ...
                            <Image src="/products-2.png" alt="img" width={800} height={600} style={{ width: '100%', height: 'auto', marginBottom: '1rem'}} className="relative"/>
                            <p className="products_text relative leading-1.2">Boost payments faster with transparent, automated tools.</p>
                        </div>
                    ...
                    <div className="card tree">
                        <div className="home-featured-products">
                            ...
                            <Image src="/products-3.png" alt="img" width={800} height={600} style={{ width: '100%', height: 'auto', marginBottom: '1rem'}} className="relative"/>
                            <p className="products_text relative leading-1.2">Boost payments faster with transparent, automated tools.</p>
                        </div>
                    </div>
                    <div className="card four md:col-span-3">
                        <div className="ai-agent">
                            ...
                            <Image src="/products-agents.png" alt="img" width={800} height={600} style={{ width: '100%', height: 'auto'}} className="relative"/>
                        </div>
                    </div>
                </div>
            </div>
